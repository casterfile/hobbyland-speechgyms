...
import { 
  ...
  Settings, Trophy, TrendingUp, Calendar, ChevronRight, Sparkles 
} from 'lucide-react';
...
export const Home: React.FC<Props> = ({ prefs, onStartSession, onViewHistory, onOpenSettings, onViewSession }) => {
